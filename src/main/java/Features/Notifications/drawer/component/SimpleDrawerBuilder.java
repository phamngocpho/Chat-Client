package Client.Features.Notifications.drawer.component;

import Client.Features.Notifications.drawer.component.footer.SimpleFooterData;
import Client.Features.Notifications.drawer.component.header.SimpleHeader;
import Client.Features.Notifications.drawer.component.header.SimpleHeaderData;
import Client.Features.Notifications.utils.FlatLafStyleUtils;
import com.formdev.flatlaf.FlatClientProperties;
import Client.Features.Notifications.drawer.component.footer.SimpleFooter;
import Client.Features.Notifications.drawer.component.menu.SimpleMenu;
import Client.Features.Notifications.drawer.component.menu.SimpleMenuOption;
