...
import Client.Features.Notifications.drawer.component.menu.data.Item;
import Client.Features.Notifications.drawer.component.menu.data.MenuItem;
...
public class SimpleMenu extends JPanel {
    ...
    private void buildMenu() {
        Client.Features.Notifications.drawer.component.menu.data.MenuItem[] menus = simpleMenuOption.menus;
        if (menus != null) {
            int index = 0;
            int validationIndex = -1;
            for (int i = 0; i < menus.length; i++) {
                Client.Features.Notifications.drawer.component.menu.data.MenuItem menuItem = menus[i];
                if (menuItem.isMenu()) {
